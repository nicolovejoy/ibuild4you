...
8. **#21 + #25 framing bundle.** Reminder copy (#21) + auto-progress to 'send nudge' after JSON import (#25). 'Waiting on {maker}' card placement already in place at `BuilderProjectView.tsx:1296`.
