...
Read CLAUDE.md in this repo first for project-specific conventions — it is the single source of truth for this project (stack, commands, data model, testing, live work). This file only carries the cross-repo shared conventions below.
